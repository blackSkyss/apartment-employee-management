 ...
 * @author VyNT
 */
public class showDepartmentEmpController extends HttpServlet {

    private final String SUCCESS = "showDepartmentEmp.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (emp == null) {
                ...
                DepartmentDTO dep = DepartmentDAO.getDepartmentByEmpId(String.valueOf(emp.getIdEmp()));
