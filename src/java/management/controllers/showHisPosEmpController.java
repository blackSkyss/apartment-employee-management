 ...
 * @author VyNT
 */
public class showHisPosEmpController extends HttpServlet {

    private final String SUCCESS = "listHisPosEmp.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (emp == null) {
                ...
                list = HistoryPosDAO.listHisPosEmp(String.valueOf(emp.getIdEmp()));
                request.setAttribute("listHisPos", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
            e.printStackTrace();
